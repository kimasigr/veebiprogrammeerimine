<?php
	...
	//kui on sisse logitud siis otse pealehele
...
<body> <body style =background-color:MISTYROSE;">
	<h1>Logi sisse!</h1>
	...
	<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
		...
		<br><br>
		<input name="loginButton" type="submit" value="Logi sisse"><span><?php echo $notice; ?></span><?php echo $notice;
		?></span>
	</form>
